...
public class ProcessDBhelper extends SQLiteOpenHelper {
	...
	/*	processvalue.setId(id);
		processvalue.setTemperature(cursor.getString(1));							//getString??????
		processvalue.setPressure(cursor.getString(2));
		processvalue.setRPM(cursor.getString(3));
		processvalue.setTorque(cursor.getString(4));
		processvalue.setOil_Level(cursor.getString(5)); 
*/
